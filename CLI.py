...
def votingResultsForState(results):
    ...
    t = PrettyTable(['State', 'Party', 'Votes', 'Total Votes'])
    for i in range(len(totalResults)):
        ...
        t.add_row([state, party, votes, votes_total])
    print(t)
    print("\n")
...
def votingResultsForCounty(results):
    ...
    if not countyList:
        ...
        t = PrettyTable(['County', 'Party', 'Votes', 'Total Votes'])
        for i in countyVotingResults:
            ...
            t.add_row([county, party, votes, total_votes])
        print(t)
        print("\n")
...
def votingResultsForAllCounties(results):
    ...
    if not countyList:
        ...
        if not countyTotalVotes:
            ...
            t = PrettyTable(['County', 'Party', 'Votes', 'Total Votes'])
            for i in range(len(countyVotingResults)):
                county = locale.format_string("%s", countyVotingResults[i][1], grouping=True)
                party = locale.format_string("%s", countyVotingResults[i][2], grouping=True)
                votes = locale.format_string("%d", countyVotingResults[i][3], grouping=True)
                total_votes = locale.format_string("%d", countyTotalVotes[i][2], grouping=True)
                t.add_row([county, party, votes, total_votes])
            print(t)
            print("\n")
...
def dataMine(results):
    ...
    print("\n")
    print("..........................................................................................")
    print("We will generate a dataset containing the demographics of a county and create a model to")
    print("predict voting results using Random Forests Classification")
    print("..........................................................................................")
    # GET THE DATA & GENERATE THE CSV
    ...
    # COMPUTE THE DATA
    print("\n")
    success = results.computeData()

    if success:
        # Results
        print("Most important factors deciding the winning party:")
        print(success[1])
        print("Predicting the voting results on test data, we get an accuracy of: " + success[0])
        print("\n")
        return not (checkContinue())
